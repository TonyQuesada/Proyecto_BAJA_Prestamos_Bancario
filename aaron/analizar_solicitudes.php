    ...
    <tbody>
      <tr>
        ...
        while ($fila = sqlsrv_fetch_array($ejecutar)) {
          ...
          echo '
              <th><input type="checkbox" name="num_soli" value="'.$num_soli.'"></th>
              <th>' . $num_soli . '</th>
              ...
              <td>¢ ' . $salario_neto . '</td>
              <td>' . $cal_sugef . '</td>
              <td><input type="submit" name="aprobar" value="APROBAR" id="boton1" onclick = "funcion();">
              <br>
              <input type="submit" name="rechazar" value="RECHAZAR" id="boton1" onclick = "funcion();"></td>
              </tr>';
        }
        ?>
    <tbody>

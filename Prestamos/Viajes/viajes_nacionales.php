...
$CATEGORIA = 'Viajes';
$PRESTAMO_COL = 'Viajes Nacionales Colones';
$PRESTAMO_DOL = 'Viajes Nacionales Dolares';
?>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    <h1 class="home__title">
                        VIAJES NACIONALES<span>.</span>
                    </h1>
                    <p class="home__description">
                        Nosotros le ayudamos a cumplir sus sueños de <span style="color: hsla(197, 100%, 42%, 0.8);">viajar</span> y disfrutar de las bellezas nacionales<span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Viajes3.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Viajes Nacionales</h3>
                                        ...
                                        <div class="product__details-benefits">
                                            ...
                                            <ul class="product__details-benefits-list">
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-cable-car' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Trámites simples
                                                        </h4>
                    ...
                    <div class="specialty__group_prestamos">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="p" id="p">
                            ...
                            <div class="l_prestamos" name="l_prestamos">
                                ...
                                <div id="DIV_col">
                                    ...
                                    <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="14" readonly="readonly">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="q" id="q">
                            ...
                            <div id="DIV_dol" style="display:none">
                                ...
                                <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="4" readonly="readonly">
                                <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="15" readonly="readonly">

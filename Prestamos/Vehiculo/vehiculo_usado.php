...
$CATEGORIA = 'Vehiculos';
$PRESTAMO_COL = 'Vehiculo Usado Colones';
$PRESTAMO_DOL = 'Vehiculo Usado Dolares';
?>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    <h1 class="home__title">
                        VEHÍCULO USADO<span>.</span>
                    </h1>
                    <p class="home__description">
                        ¡Es hora de comprar ese <span style="color: hsla(197, 100%, 42%, 0.8);">vehículo</span> con el que tanto sueña! Adquiera el <span style="color: hsla(197, 100%, 42%, 0.8);">vehículo usado</span> que se ajusta a su presupuesto<span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Vehiculo2.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Vehículo Usado</h3>
                                        ...
                                        <div class="product__details-benefits">
                                            ...
                                            <ul class="product__details-benefits-list">
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-credit-card' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Tasas competitivas
                                                        </h4>
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-car' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Convenio con las principales agencias
                                                        </h4>
                                                        <p>Preguntá a tu agente BAJA cuáles son y los beneficios que tenemos con cada uno de ellos.</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="product__details-center-col">
                                        ...
                                        <div class="product__formalities">
                                            <div>
                                                ...
                                                <p>- Antigüedad mínima laboral de 10 meses.</p>
                                                <p>- Estados de cuenta de los últimos 5 meses.</p>
                                                <p>- Fotocopia del documento de identificación vigente.</p>
                                                <p>- Factura proforma del vehículo (moneda del crédito a solicitar)</p>
                                                <p>- De acuerdo a su actividad económica su ejecutivo le solicitará información.</p>
                    ...
                    <div class="specialty__group_prestamos">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="p" id="p">
                            ...
                            <div class="l_prestamos" name="l_prestamos">
                                ...
                                <div id="DIV_col">
                                    ...
                                    <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="3" readonly="readonly">
                                    <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="10" readonly="readonly">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="q" id="q">
                            ...
                            <div id="DIV_dol" style="display:none">
                                ...
                                <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="3" readonly="readonly">
                                <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="11" readonly="readonly">

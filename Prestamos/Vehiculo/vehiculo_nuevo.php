...
$CATEGORIA = 'Vehiculos';
$PRESTAMO_COL = 'Vehiculo Nuevo Colones';
$PRESTAMO_DOL = 'Vehiculo Nuevo Dolares';
?>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    <h1 class="home__title">
                        VEHÍCULO NUEVO<span>.</span>
                    </h1>
                    <p class="home__description">
                        ¡Nada como el olor a <span style="color: hsla(197, 100%, 42%, 0.8);">vehiculo nuevo</span>! Le acompañamos a emprender ese nuevo camino de estrenar un vehículo 0km<span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Vehiculo1.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Vehículo Nuevo</h3>
                                    ...
                                    <div class="product__details-center-col">
                                        ...
                                        <div class="product__formalities">
                                            <div>
                                                ...
                                                <p>- Antigüedad mínima laboral de 12 meses.</p>
                                                <p>- Estados de cuenta de los últimos 6 meses.</p>
                    ...
                    <div class="specialty__group_prestamos">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="p" id="p">
                            ...
                            <div class="l_prestamos" name="l_prestamos">
                                ...
                                <div id="DIV_col">
                                    ...
                                    <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="8" readonly="readonly">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="q" id="q">
                            ...
                            <div id="DIV_dol" style="display:none">
                                ...
                                <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="3" readonly="readonly">
                                <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="9" readonly="readonly">

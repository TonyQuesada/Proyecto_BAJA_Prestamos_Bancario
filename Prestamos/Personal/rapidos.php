...
$PRESTAMO_COL = 'Rapidos Colones';
$PRESTAMO_DOL = 'Rapidos Dolares';
?>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    ...
                    <p class="home__description">
                        Te brindamos un crédito de <span style="color: hsla(197, 100%, 42%, 0.8);">rápida</span> aprobación para tus necesidades inmediatas<span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Personal2.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Rápiditos</h3>
                                        ...
                                        <div class="product__details-benefits">
                                            ...
                                            <ul class="product__details-benefits-list">
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-message-check' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Aprobación inmediata
                                                        </h4>
                                                        <p>Si cumples con los requisitos te aprobamos el crédito de forma inmediata.</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div>
                                                ...
                                                <li>
                                                    <div>
                                                        ...
                                                        <p>Disminuye el pago de cuota a un plazo de 60 meses.
                                                        </p>
                                                    </div>
                                                </li>
                                            </ul>

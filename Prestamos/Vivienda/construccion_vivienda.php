...
$CATEGORIA = 'Vivienda';
$PRESTAMO_COL = 'Construccion Vivienda Colones';
$PRESTAMO_DOL = 'Construccion Vivienda Dolares';
?>
...
<head>
    ...
    <title>Construcción de Vivienda</title>
</head>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    <h1 class="home__title">
                        CONSTRUCCIÓN DE VIVIENDA<span>.</span>
                    </h1>
                    <p class="home__description">
                        Te ofrecemos un crédito hecho a tu medida para la <span style="color: hsla(197, 100%, 42%, 0.8);">construcción </span>de tu hogar <span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Vivienda1.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Construcción de Vivienda</h3>
                                        ...
                                        <div class="product__details-benefits">
                                            ...
                                            <ul class="product__details-benefits-list">
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-calendar-check' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>

...
<head>
    ...
    <title>Vivienda de Interes Social</title>
</head>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            <div class="home__container">
                <div class="home__content container">
                    <h1 class="home__title">
                        VIVIENDA DE INTERES SOCIAL<span>.</span>
                    </h1>
                    <p class="home__description">
                        Te ofrecemos la posibilidad de <span style="color: hsla(197, 100%, 42%, 0.8);">mejorar su calidad de vida</span> y la de sus seres queridos, con viviendas al alcance de todos<span style="color: hsla(197, 100%, 42%, 0.8);">.</span>
                    </p>
            ...
            <video src="../../assets/video/Vivienda2.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                ...
                <div class="specialty__category_prestamos">
                    ...
                    <div class="">
                        <div class="home__data_prestamos">
                            <div class="home__data-group">
                                <h3 class="home__data-title" style="color: hsl(208, 100%, 25%); font-size: calc(var(--h1-font-size) - 4px);">BAJA - Vivienda de Interes Social</h3>
                                        ...
                                        <div class="product__details-benefits">
                                            ...
                                            <ul class="product__details-benefits-list">
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bxs-home-heart' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Flexibilidad
                                                        </h4>
                                                ...
                                                <li>
                                                    <div>
                                                        <h4>
                                                            <i class='bx bx-search-alt' style="color:#00182e; font-size: var(--h3-font-size); margin-right: 7px"></i>
                                                            Asesoría personalizada
                                                        </h4>
                                                        <p>Te escuchamos y ofrecemos el plan más apto para tu proyecto.</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="product__details-center-col">
                                        ...
                                        <div class="product__formalities">
                                            <div>
                                                ...
                                                <p>- Estados de cuentas bancarias e inversiones de los últimos seis meses.</p>
                    ...
                    <div class="specialty__group_prestamos">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="p" id="p">
                            ...
                            <div class="l_prestamos" name="l_prestamos">
                                ...
                                <div id="DIV_col">
                                    ...
                                    <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="7" readonly="readonly">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="q" id="q">
                            ...
                            <div id="DIV_dol" style="display:none">
                                ...
                                <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="2" readonly="readonly">
                                <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="20" readonly="readonly">

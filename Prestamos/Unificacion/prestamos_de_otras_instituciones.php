...
$PRESTAMO_COL = 'Prestamos otras instituciones Colones';
$PRESTAMO_DOL = 'Prestamos otras instituciones Dolares';
?>
...
<head>
    ...
    <title>Prestamos otras instituciones</title>
</head>
...
<body>
    ...
    <main class="main" id="main">
        ...
        <section class="home grid" id="home">
            ...
            <video src="../../assets/video/Unificacion2.mp4" class="home__video" type="video/mp4" autoPlay loop muted playsInline></video>
                    ...
                    <div class="specialty__group_prestamos">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="p" id="p">
                            ...
                            <div class="l_prestamos" name="l_prestamos">
                                ...
                                <div id="DIV_col">
                                    ...
                                    <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="18" readonly="readonly">
                        ...
                        <form action="../formulario.php#formulario" method="post" name="q" id="q">
                            ...
                            <div id="DIV_dol" style="display:none">
                                ...
                                <input hidden type="number" id="id_Categoria_Prestamo" name="id_Categoria_Prestamo" value="5" readonly="readonly">
                                <input hidden type="number" id="id_Tipo_Prestamo" name="id_Tipo_Prestamo" value="19" readonly="readonly">
